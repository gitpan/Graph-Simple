#############################################################################
# Path and cell management for Graph::Simple.
#
# (c) by Tels 2004-2005.
#############################################################################

package Graph::Simple::Layout::Path;
...
C<Graph::Simple::Layout::Scout> contains just the actual path-managing code for
L<Graph::Simple|Graph::Simple>, e.g. to create/destroy/maintain paths, node
placement etc.
